        ...
        <div className="single__product__right">
          {language === "EN" ? (
            <article className="product__description">
              ...
              is a popular card game, played mainly in Bavaria. It is also known
              as{" "}
              <span className="product__description--accent">
                {" "}
                the Game of 66
              </span>
              . This project demonstrates a short 2-player version of it, played
              agains the computer with a fixed difficulty. <br /> <br /> Player
              can choose between different textures for the table and different
              types of cards. The tutorial can be viewed anytime for a quick
              reference. The scoreboard displays the points of each player. The
              winner of 2 of 3 rounds wins the game! <br /> <br /> The project
              is build in{" "}
              <span className="product__description--accent">React</span>{" "}
              framework and intended only for wide-screen devices. <br /> <br />
              <span className="product__description--accent">→</span> This
              project is an ongoing project. In the future it will feature an
              online-mode, which will be playable against another player. It
              will also include differen difficulty settings for the CPU.
            </article>
          ) : (
            <article className="product__description">
              <span className="product__description--accent--pr">
              ...
              ist ein beliebtes Kartenspiel, das hauptsächlich in Bayern
              gespielt wird. Es ist auch bekannt als{" "}
              <span className="product__description--accent">
                das Spiel der 66
              </span>
              . Dieses Projekt demonstriert eine kurze 2-Spieler-Version, die
              gegen den Computer mit einer festen Schwierigkeit gespielt wird.{" "}
              <br /> <br /> Der Spieler kann zwischen verschiedenen Texturen für
              den Tisch und verschiedenen Kartentypen wählen. Das Tutorial kann
              jederzeit zur schnellen Referenz angesehen werden. Die
              Anzeigetafel zeigt die Punkte jedes Spielers an. Der Gewinner von
              2 von 3 Runden gewinnt das Spiel! <br /> <br /> Das Projekt ist im{" "}
              <span className="product__description--accent">React</span>
              -Framework gebaut und nur für Breitbildgeräte gedacht. <br />{" "}
              <br />
              <span className="product__description--accent">→</span> Dieses
              Projekt ist ein laufendes Projekt. In Zukunft wird es einen
              Online-Modus bieten, der gegen einen anderen Spieler spielbar sein
              wird. Es wird auch verschiedene Schwierigkeitsstufen für die CPU
              enthalten.
            </article>
          )}
