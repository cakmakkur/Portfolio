    ...
    <div className="contact__page__main">
      {!messageSent ? (
        <form className="contact__form__div" onSubmit={handleSubmit}>
          ...
          <label className="contact__label">
            <input
              ...
              required
            />
            <span ref={namePhRef} className="form__ph__text">
              Name
            </span>
          </label>
          <label className="contact__label">
          ...
          <label className="contact__label">
            <input
              ...
              required
            />
            <span ref={subjectPhRef} className="form__ph__text">
          ...
          <label className="contact__label">
            <textarea
              ...
              required
            />
            <span ref={messagePhRef} className="form__ph__text">
          ...
          <div className="view__product__btn__div">
            ...
            >
              ...
              >
                {language === "EN" ? "CONTACT ME" : "ABSENDEN"}
              </button>
            </div>
          </div>
        </form>
        ...
        <div className="sentSuccessfully">
          <h3>
            <img src={checkLogo} alt="" /> Message Sent Successfully
          </h3>
          <div className="view__product__btn__div">
            <div
              ref={sendMessageRef}
